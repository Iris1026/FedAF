...
from nni.compression.torch.pruning \
...
def get_threshold_by_sparsity(mapper:dict, sparsity:float):
    ...
    k = int(tf_idf_array.shape[0] * (1 - sparsity))
    #print("TF-IDF array contains NaN:", torch.isnan(tf_idf_array).any())
    #print("TF-IDF array contains Inf:", torch.isinf(tf_idf_array).any())
    #print("Value of k for topk:", k)
