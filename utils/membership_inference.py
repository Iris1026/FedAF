...
def attack(target_model, attack_model, client_loaders, test_loader, args):
...
def train_attack_model(shadow_old_GM, shadow_client_loaders, shadow_test_loader, args):
